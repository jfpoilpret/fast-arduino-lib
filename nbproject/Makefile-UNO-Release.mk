...
${OBJECTDIR}/cores/fastarduino/NRF24L01.o: nbproject/Makefile-${CND_CONF}.mk cores/fastarduino/NRF24L01.cpp 
	${MKDIR} -p ${OBJECTDIR}/cores/fastarduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Icores -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cores/fastarduino/NRF24L01.o cores/fastarduino/NRF24L01.cpp

${OBJECTDIR}/cores/fastarduino/NRF24L01_impl.o: nbproject/Makefile-${CND_CONF}.mk cores/fastarduino/NRF24L01_impl.cpp 
	${MKDIR} -p ${OBJECTDIR}/cores/fastarduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Icores -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cores/fastarduino/NRF24L01_impl.o cores/fastarduino/NRF24L01_impl.cpp

${OBJECTDIR}/cores/fastarduino/RTT.o: nbproject/Makefile-${CND_CONF}.mk cores/fastarduino/RTT.cpp 
	${MKDIR} -p ${OBJECTDIR}/cores/fastarduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Icores -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cores/fastarduino/RTT.o cores/fastarduino/RTT.cpp
...
${OBJECTDIR}/cores/fastarduino/WinBond.o: nbproject/Makefile-${CND_CONF}.mk cores/fastarduino/WinBond.cpp 
	${MKDIR} -p ${OBJECTDIR}/cores/fastarduino
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Icores -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/cores/fastarduino/WinBond.o cores/fastarduino/WinBond.cpp
