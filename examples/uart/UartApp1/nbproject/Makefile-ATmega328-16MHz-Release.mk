...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/uartapp1: ../../../dist/ATmega328-16MHz-Release/AVR-GNU-Toolchain-3.5.3-Linux/libfastarduino.a
...
${OBJECTDIR}/UARTApp1.o: UARTApp1.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -Wall -I../../../cores -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UARTApp1.o UARTApp1.cpp
