...
using SONAR1 = devices::old_sonar::HCSR04<TIMER, TRIGGER, ECHO1, SonarType::ASYNC_PCINT>;
using SONAR2 = devices::old_sonar::HCSR04<TIMER, TRIGGER, ECHO2, SonarType::ASYNC_PCINT>;
