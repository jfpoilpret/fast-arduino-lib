...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/eventapp2.exe: ../../../dist/UNO-Release/AVR-GNU-Toolchain-3.5.3-Linux-x86/libfastarduino.a
...
${OBJECTDIR}/EventApp2.o: EventApp2.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -Wall -DARDUINO_UNO -I../../../cores -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EventApp2.o EventApp2.cpp
