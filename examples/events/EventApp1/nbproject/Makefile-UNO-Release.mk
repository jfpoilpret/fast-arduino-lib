...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/eventapp1.exe: ../../../dist/UNO-Release/AVR-GNU-Toolchain-3.5.3-Linux-x86/libfastarduino.a
...
${OBJECTDIR}/EventApp1.o: EventApp1.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -Wall -DARDUINO_UNO -I../../../cores -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EventApp1.o EventApp1.cpp
