...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/fastpin1: ../../../dist/ATmega328-Release/AVR-GNU-Toolchain-3.5.3-Linux/libfastarduino.a
...
${OBJECTDIR}/TestIsr.o: TestIsr.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -Wall -I../../../cores -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestIsr.o TestIsr.cpp
