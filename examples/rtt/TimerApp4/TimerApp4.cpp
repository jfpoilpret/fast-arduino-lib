...
constexpr const BLINK_TIMER_TYPE::TIMER_PRESCALER BLINK_PRESCALER = BLINK_TIMER_TYPE::timer_prescaler(BLINK_PERIOD_US);
...
constexpr const SUSPEND_TIMER_TYPE::TIMER_PRESCALER SUSPEND_PRESCALER = SUSPEND_TIMER_TYPE::timer_prescaler(SUSPEND_PERIOD_US);
