 ...
 * to work properly.
 * @param T the data type of Event to be generated by the watchdog
 * @sa watchdog::Watchdog
 */
#define REGISTER_WATCHDOG_CLOCK_ISR(T)	\
REGISTER_ISR_METHOD_(WDT_vect, watchdog::Watchdog<T>, &watchdog::Watchdog<T>::on_tick)
