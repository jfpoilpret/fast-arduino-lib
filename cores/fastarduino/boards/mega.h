...
extern "C" {
	...
	void INT4_vect(void) SIGNAL_HANDLER;
	void INT5_vect(void) SIGNAL_HANDLER;
	void INT6_vect(void) SIGNAL_HANDLER;
	void INT7_vect(void) SIGNAL_HANDLER;
	...
	void TIMER4_COMPC_vect(void) SIGNAL_HANDLER;
	void TIMER4_OVF_vect(void) SIGNAL_HANDLER;
	void TIMER4_CAPT_vect(void)  SIGNAL_HANDLER;
	void TIMER5_COMPA_vect(void) SIGNAL_HANDLER;
	void TIMER5_COMPB_vect(void) SIGNAL_HANDLER;
	void TIMER5_COMPC_vect(void) SIGNAL_HANDLER;
	void TIMER5_OVF_vect(void) SIGNAL_HANDLER;
	void TIMER5_CAPT_vect(void)  SIGNAL_HANDLER;
	...
	void USART2_UDRE_vect(void) SIGNAL_HANDLER;
	void USART2_RX_vect(void) SIGNAL_HANDLER;
	void USART2_TX_vect(void) SIGNAL_HANDLER;
	void USART3_UDRE_vect(void) SIGNAL_HANDLER;
	void USART3_RX_vect(void) SIGNAL_HANDLER;
	void USART3_TX_vect(void) SIGNAL_HANDLER;
