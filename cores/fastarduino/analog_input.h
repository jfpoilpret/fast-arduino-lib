...
namespace analog
{
	...
	public:
		...
		SAMPLE_TYPE sample()
		{
			...
			GLOBAL_TRAIT::ADCSRA_ = bits::BV8(ADEN, ADSC) | TRAIT::MUX_MASK2 | FREQ_TRAIT::PRESCALER_MASK;
	...
	//TODO Implement mechanism to ensure only DeferredAnalogInput can be registered 
	// (need sth like one AnalogInputManager?)
